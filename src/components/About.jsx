  ...
  return (
    ...
    <div className="max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full">
      ...
      <p>
        ...
        into programming began while analyzing and visualizing complex research
        data, and I was instantly captivated by its transformative power. This
        profound interest led me to embark on a career path where I could refine
        my natural problem-solving abilities through the medium of programming.
      </p>
      <br />
      <p className="text-xl">
