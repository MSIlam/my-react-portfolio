...
const About = () => {
  return (
    <div
      name="about"
      className="w-full mx-auto bg-gradient-to-b from-gray-800 to-black text-white h-screen"
    >
      <div className="max-w-screen-lg p-4 mx-auto flex flex-col items-center w-full justify-center h-full px-4">
        <div className="pb-8">
